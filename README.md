...
[![Version](https://img.shields.io/badge/version-v4.5.0-blue.svg)](https://github.com/Electrode-iOS/ELWebService/releases/latest)
...
```
github "Electrode-iOS/ELWebService" ~> 4.5.0
```
