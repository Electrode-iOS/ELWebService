...
[![Version](https://img.shields.io/badge/version-v4.3.0-blue.svg)](https://github.com/Electrode-iOS/ELWebService/releases/latest)
...
```
github "Electrode-iOS/ELWebService" ~> 4.3.0
```
