...
[![Version](https://img.shields.io/badge/version-v4.0.2-blue.svg)](https://github.com/Electrode-iOS/ELWebService/releases/latest)
...
```
github "Electrode-iOS/ELWebService" ~> 4.0.2
```
