...
[![Version](https://img.shields.io/badge/version-v4.2.0-blue.svg)](https://github.com/Electrode-iOS/ELWebService/releases/latest)
...
ELWebService requires Swift 3.1 and Xcode 8.3.
...
```
github "Electrode-iOS/ELWebService" ~> 4.2.0
```
